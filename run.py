...
def thread2():
    ...
    for i in range(100000):
        # print(runforStep_gymGame_command)
...
def run(env, a):
    ...
    all_log_path = ['out/logs/', 'out/csvfile/', 'out/savemodel/target/']
    ...
    while True:  # Run until solved
        ...
        while True:
            ...
            if state_flag > 65 or state_flag < 35:
                stepFlag = False
                break
            ...
            # print(a.t_step, "action:", action, "reward: %.5f" % reward, "fanpower: %.5f" % fan_power)
        ...
        if episode % 100 == 0:
            print('episode', episode, 'score %.5f' % sum(rewards_history),
                  'score_max %.5f' % max(Reward_history), 'FanPowerSUM %.5f' % sum(fan_power_history))
        ...
        if episode % 200 == 0:
            ...
            a.network_target.save_weights(all_log_path[2] + 'RHfile_' + str(episode))
